...
<form class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" id="date" name="date" class="input-text Wdate" style="width:120px;">
		</div>
	</div>
	<div class="row cl">
...
<script type="text/javascript">
    $(function(){
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "${pageContext.request.contextPath}/acticle/add" ,
    ...
    var point = new BMap.Point(106.16,29.18);
