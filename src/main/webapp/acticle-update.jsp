...
<form class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${acticle.title}" placeholder="" id="title" name="title">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>时间</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" id="date" name="date" value="${acticle.date}" class="input-text Wdate" style="width:120px;">
		</div>
	</div>
	<input type="hidden" class="input-text" value="${acticle.id}" placeholder="" id="id" name="id">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>地点</label>
			<div id="allmap"></div>
			<div id="r-result">
				<input type="hidden"  name="wd" id="wd"/><input type="hidden"  name="jd"id="jd"/>
			</div>
	</div>
	<c:forEach  var="img" items="${requestScope.acticle.imgList}"  varStatus="varSta">
		<div class="row cl">
			<div class="formControls col-xs-8 col-sm-9">
				...
				<a style="text-decoration:none;width: 50px;height:50px;" onClick="product_del(this,${img.id})" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</div>
		</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<script id="container" name="conten"  type="text/plain">
            </script>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '${pageContext.request.contextPath}/imgupload',
                ...
                if ( file.getStatus() === 'invalid' ) {
                    ...
                    uploader.makeThumb( file, function( error, src ) {
                        ...
                        if( isSupportBase64 ) {
                            ...
                            $.ajax('${pageContext.request.contextPath}/imgupload', {
                                method: 'POST',
                                data: src,
                                dataType:'json'
...
<script type="text/javascript">
    $(function(){
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "${pageContext.request.contextPath}/updateActicle" ,
    ...
    function product_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type:'get',
                url:  '${pageContext.request.contextPath}/deleteImg?id='+id,
                dataType: 'text',
                success: function(data){
    ...
    map.addEventListener("click",function(e){
        ...
        input.value = e.point.lat;
        input2.value= e.point.lng;
