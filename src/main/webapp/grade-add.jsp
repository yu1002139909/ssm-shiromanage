...
<form class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="grade_year" name="year"  onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})">
		</div>
	</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: '${pageContext.request.contextPath}/upload2',
                ...
                if ( file.getStatus() === 'invalid' ) {
                    ...
                    uploader.makeThumb( file, function( error, src ) {
                        ...
                        if( isSupportBase64 ) {
                            ...
                            $.ajax('${pageContext.request.contextPath}/upload2', {
                                method: 'POST',
                                data: src,
                                dataType:'json'
