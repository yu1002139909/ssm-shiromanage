  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			...
			<ul class="header-bar">
				<li class="header-bar-role"><a href="javascript:;">欢迎你！</a></li>
				<li class="header-bar-nav">
					<a href="javascript:;">${sessionScope.userInfo.username}<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
					<ul class="header-dropdown-menu">
						<li><a href="${pageContext.request.contextPath}/user/editUi?id=${sessionScope.userInfo.id}">个人信息</a></li>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/common/lib/jquery-1.9.0.min.js">
	</script>
