...
<head>
	...
	<title>修改班级信息 - H-ui.admin 3.0</title>
	<meta name="keywords" content="H-ui.admin 3.0,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
	<meta name="description" content="H-ui.admin 3.0，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<form action="${pageContext.request.contextPath}/grade/update.action?grade_id=${grade.grade_id}" method="post" class="form form-horizontal" id="form-member-add"  enctype="multipart/form-data">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>班级编号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${grade.grade_name}" placeholder="" id="grade_name" name="grade_name">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>入学年份：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${grade.year}" placeholder="" id="grade_year" name="year" onfocus="WdatePicker({'dateFmt':'yyyy'})">
		</div>
	</div>
	<div class="row cl">
		<img src="${pageContext.request.contextPath}/${grade.photo}"><br/>
