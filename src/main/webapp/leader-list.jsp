...
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入领导名称"  name="">
		...
		<thead>
			...
			<c:forEach  var="leader" items="${requestScope.leaderList}" varStatus="varSta">
				<tr class="text-c">
					...
					<td>${leader.name}</td>
					<td>${leader.work}</td>
					<td>${leader.synopsis}</td>
					<td><img src="${pageContext.request.contextPath}/${leader.photo}" width="100px" height="100px"></td>
