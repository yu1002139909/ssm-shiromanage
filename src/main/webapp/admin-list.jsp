...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','${pageContext.request.contextPath}/user/addUi','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<c:forEach  var="admin" items="${requestScope.userList}" varStatus="varSta">
				<tr class="text-c">
					...
					<td>${admin.state}</td>
					<td>
						<fmt:formatDate value="${admin.createTime}" pattern="yyyy年MM月dd日"/></td>
